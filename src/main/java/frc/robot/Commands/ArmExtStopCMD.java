...
public class ArmExtStopCMD extends CommandBase {
  /** Creates a new ArmStopCMD. */
  ArmExtensionSubsystem m_ArmExtensionSubsystem;
  public ArmExtStopCMD(ArmExtensionSubsystem param_ArmExtensionSubsystem) {
  ...
  public void initialize() {
    m_ArmExtensionSubsystem.ExtArmStop();
  }
